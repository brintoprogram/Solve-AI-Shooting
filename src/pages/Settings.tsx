      ...
      <div className="max-w-2xl mx-auto px-6 py-8 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-agro-muted mt-1.5">
                  Use um System User Token permanente, não um token de usuário temporário.
                </p>
              </div>
        ...
        <div className="animate-fade-up-delay-1">
          <DarkCard
            ...
            subtitle="Configure esses valores no painel Meta for Developers → Seu App → WhatsApp → Configuration → Webhook."
          >
            <div className="space-y-4">
              <div>
                <FieldLabel>URL do Webhook</FieldLabel>
                <div className="flex gap-2">
                  <input className="input-agro flex-1 font-mono text-xs" value={webhookUrl} readOnly />
                  <button
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input className="input-agro flex-1 font-mono text-xs" value={form.webhook_verify_token} readOnly />
                  <button
                ...
                <p className="text-xs text-agro-muted mt-1.5">Cole esse token no campo "Verify Token" no painel da Meta.</p>
              </div>
